...
public class GridManagerPainter : MonoBehaviour
{
    ...
    //     gridBuffer?.Release();
    //     
    //     EventSystem<Vector3, EntityTileID>.Unsubscribe(EventType.SELECT_TILE_DOWN, StartChangingTile);
    //     EventSystem<Vector3, EntityTileID>.Unsubscribe(EventType.SELECT_TILE, PlacementSelection);
    //     EventSystem<Vector3, EntityTileID>.Unsubscribe(EventType.CHANGE_TILE, ChangeTile);
    //     EventSystem<Vector3, EntityTileID>.Unsubscribe(EventType.FORCE_CHANGE_TILE, ForceChangeTile);
    // }
    //
    // private void Awake()
    // {
    //     EventSystem<Vector3, EntityTileID>.Subscribe(EventType.SELECT_TILE_DOWN, StartChangingTile);
    //     EventSystem<Vector3, EntityTileID>.Subscribe(EventType.SELECT_TILE, PlacementSelection);
    //     EventSystem<Vector3, EntityTileID>.Subscribe(EventType.CHANGE_TILE, ChangeTile);
    //     EventSystem<Vector3, EntityTileID>.Subscribe(EventType.FORCE_CHANGE_TILE, ForceChangeTile);
    //     
    ...
    //         if (gridObjectIsNull)
    //         {
    //             tileID = (int)startFillEntityTileID;
    //         }
    //         else
    //         {
    ...
    //
    //         tileIDs[IndexPosToIndex(new Vector2Int(x, y))] = (EntityTileID)tileID;
    //     }
    //     matricesList[(int)EntityTileID.WATER] = matricesList[(int)EntityTileID.WATER].OrderBy(x => x.GetRow(2).w).ToList();
    //
    ...
    // }
    //
    // private void StartChangingTile(Vector3 position, EntityTileID entityTileID)
    // {
    ...
    //     selectionMeshFilter.sharedMesh = tileObject.tileSettings[(int)entityTileID].mesh;
    // }
    //
    ...
    //         return;
    //
    //     EntityTileID oldEntityTile = tileIDs[IndexPosToIndex(posIndex)];
    //     if (oldEntityTile == entityTileID)
    //         return;
    //     
    ...
    //     }
    //     bool requiredPlacement = GetRequiredSelection(entityTileID, posIndex, RequiredSelection);
    //
    //     void ConstraintSelection(int index) { 
    //         selectionColors[index] = constrainedColor;
    //     }
    //     bool constrained = GetConstraintSelection(entityTileID, posIndex, ConstraintSelection);
    //     
    ...
    //     }
    //
    //     if (entityTileID != beforeSelectionEntityTileID)
    //     {
    //         beforeSelectionEntityTileID = entityTileID;
    //         selectionMeshRenderer.material.SetTexture(AlbedoMap, tileObject.tileSettings[(int)entityTileID].texture);
    //     }
    //     
    //     selectionObject.transform.position = new Vector3(Mathf.RoundToInt(position.x), Mathf.RoundToInt(position.y), Mathf.RoundToInt(position.z));
    //     
    ...
    //     bool hasEnoughApples = amountApples >= tileObject.tileSettings[(int)entityTileID].appleCost || entityTileID == EntityTileID.DIRT;
    //     
    ...
    //     
    //     tileIDs[IndexPosToIndex(posIndex)] = entityTileID;
    //     if (oldEntityTile == EntityTileID.WATER)
    //     {
    //         matricesList[(int)oldEntityTile].Remove(matrix4X4);
    //     }
    //     else
    //     {
    ...
    // }
    //
    // private void ForceChangeTile(Vector3 position, EntityTileID entityTileID)
    // {
    //     Vector2Int posIndex = GetTile(position);
    //     EntityTileID oldEntityTile = tileIDs[IndexPosToIndex(posIndex)];
    //
    //     if (oldEntityTile == EntityTileID.WATER && entityTileID == EntityTileID.DAMM)
    //     {
    //         entityTileID = EntityTileID.DAMM_WATER;
    //     }
    //     
    //     Matrix4x4 matrix4X4 = IndexToMatrix4x4(posIndex);
    //     
    ...
    //     matricesList[(int)entityTileID].Add(matrix4X4);
    // }
    // private void ForceChangeTile(Vector2Int posIndex, EntityTileID entityTileID)
    // {
    //     EntityTileID oldEntityTile = tileIDs[IndexPosToIndex(posIndex)];
    //     
    //     if (oldEntityTile == EntityTileID.WATER && entityTileID == EntityTileID.DAMM)
    ...
    //     foreach (AreaSelection areaSelection in tileObject.tileSettings[(int)entityTileID].selection)
    //     {
    ...
    //     foreach (AreaConstraint placementConstraint in tileObject.tileSettings[(int)entityTileID].placementConstraints)
    //     {
    ...
    //     Vector2Int cachedIndex = new Vector2Int();
    //     bool meetsRequirements = true;
    //     foreach (AreaRequirement areaRequirement in tileObject.tileSettings[(int)entityTileID].placementRequirements)
    //     {
